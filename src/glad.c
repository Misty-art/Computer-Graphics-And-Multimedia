...
{
	if (!GLAD_GL_EXT_texture_filter_minmax)
		return;
...
{
	if (!GLAD_GL_OES_point_size_array)
		return;
...
{
	if (!GLAD_GL_OES_texture_cube_map)
		return;
...
{
	if (!GLAD_GL_IMG_user_clip_plane)
		return;
...
{
	if (!GLAD_GL_OES_blend_equation_separate)
		return;
...
{
	if (!GLAD_GL_OES_framebuffer_object)
		return;
...
{
	if (!GLAD_GL_OES_blend_func_separate)
		return;
